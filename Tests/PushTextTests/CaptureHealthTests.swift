...
struct CaptureHealthTests {
    ...
    func cleanupResultReachesTheInjector() async {
        ...
        let model = AppModel(engine: engine, capture: capture, injector: injector,
                             ...
                             settingsStore: FakeSettings(settings: AppSettings(cleanupEnabled: true, hotkeyKeyCode: HotkeyBinding.rightOption.keyCode, soundEnabled: true, silenceWhileDictating: false)))
    ...
    func cleanupSkippedWhenDisabled() async {
        ...
        let model = AppModel(engine: engine, capture: capture, injector: injector,
                             cleanup: cleanup,
                             settingsStore: FakeSettings(settings: AppSettings(cleanupEnabled: false, hotkeyKeyCode: HotkeyBinding.rightOption.keyCode, soundEnabled: true, silenceWhileDictating: false)))
